...
public class TCMS_FETCH_SELECTION_CRITERIA_ID extends Coupon_Common{
    Response resp;
    String url=TCMS_CRITERIA_ENDPOINT+tcms_fetch_criteria_id;

    @Test
    public void fetch_selection_criteria_id()
    {
       resp= RestAssured.given().
               ...
               get(url);
        Fetch_Selectioncriteriaid(resp);
